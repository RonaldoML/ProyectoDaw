  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="col-lg-4">
          ...
          <p><a class="btn btn-danger" href="odebretcharea2.php" style="position: absolute; top: 290px; left:0px; width: 190px; height: 50px; "role="button">GRAFICA NUEVA&raquo;</a></p>
          

          
          <a href="panorama.html"><img src="img/atras.png" style="position: absolute; top: 420px; left:40px; width: 90px; height: 50px;"></a>
        </div><!-- /.col-lg-4 -->
