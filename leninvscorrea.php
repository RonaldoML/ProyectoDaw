...
<html>
  ...
  <div class="col-lg-4">
          ...
          <p><a class="btn btn-warning" href="likeslenin.php" style="position: absolute; top: 50px; left:0px; width: 170px; height: 50px; "role="button">LENIN LIKES &raquo;</a></p>
          <p><a class="btn btn-secondary" href="likescorrea.php" style="position: absolute; top: 130px; left:0px; width: 170px;height: 50px; "role="button">CORREA LIKES &raquo;</a></p>
          <p><a class="btn btn-warning" href="rtlenin.php" style="position: absolute; top: 200px; left:0px; width: 170px;height: 50px; "role="button">LENIN RT &raquo;</a></p>
          <p><a class="btn btn-secondary" href="rtcorrea.php" style="position: absolute; top: 270px; left:0px; width: 170px;height: 50px; "role="button">CORREA RT &raquo;</a></p>
